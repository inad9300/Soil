import {And, IsA, IsCallback, IsIndexSignature, IsReadonly, Not, Or, Primitive} from './Types'
            ...
            : E[P] extends Function
                ? IsReadonly<E, P> extends true
                    ...
                    : IsCallback<E[P]> extends true
                        ? P
                        : never
                : And<IsReadonly<E, P>, Or<IsA<E[P], EventTarget>, Or<IsA<E[P], HTMLCollectionBase>, IsA<E[P], NodeList>>>> extends true
                    ? never
                    : P
